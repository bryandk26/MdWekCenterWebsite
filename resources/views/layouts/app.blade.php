                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{ route('searchPage') }}">{{ __('Search Product') }}</a>
                            </li>
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if (Auth::user()->role_as==1)
                                        <a class="dropdown-item" href="{{ route('insertproduct') }}">
                                            {{ __('Insert Product') }}
                                        </a>
...
<footer class="text-center text-white bg-info mt-auto" >
